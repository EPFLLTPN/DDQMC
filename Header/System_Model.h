...
public:
	...
	//std::unordered_map<std::array<unsigned int, ByteS>, double>::const_iterator find_elm;

	struct Model_Properties
		{
			int xSite, ySite, Nsite;
	...
	std::string OutputGen(int cycle, int target_nbr, double shift, std::bitset<Bl> reference, double tau, std::string & paath, int seed, double shift_const, double imp);
};
